...
public class BiodataActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.activity_biodata, container, false);
        inItAll(view);
        return view;
   ...
   */
    ...
    private void inItAll(View view) {
        image_show_hide=view.findViewById(R.id.image_show_hide);
        image_show_hide2=view.findViewById(R.id.image_show_hide2);
        image_show_hide3=view.findViewById(R.id.image_show_hide3);
        image_show_hide4=view.findViewById(R.id.image_show_hide4);
        image_show_hide5=view.findViewById(R.id.image_show_hide5);
        image_show_hide6=view.findViewById(R.id.image_show_hide6);
        image_show_hide7=view.findViewById(R.id.image_show_hide7);
        image_show_hide8=view.findViewById(R.id.image_show_hide8);
        image_show_hide9=view.findViewById(R.id.image_show_hide9);



        mother_layout_profile=view.findViewById(R.id.monther_layout_profile);
        mother_layout_profile.getLayoutTransition().enableTransitionType(LayoutTransition.CHANGING);
        mother_layout_profile2=view.findViewById(R.id.monther_layout_profile2);
        mother_layout_profile2.getLayoutTransition().enableTransitionType(LayoutTransition.CHANGING);
        mother_layout_profile3=view.findViewById(R.id.monther_layout_profile3);
        mother_layout_profile3.getLayoutTransition().enableTransitionType(LayoutTransition.CHANGING);
        mother_layout_profile4=view.findViewById(R.id.monther_layout_profile4);
        mother_layout_profile4.getLayoutTransition().enableTransitionType(LayoutTransition.CHANGING);
        mother_layout_profile5=view.findViewById(R.id.monther_layout_profile5);
        mother_layout_profile5.getLayoutTransition().enableTransitionType(LayoutTransition.CHANGING);
        mother_layout_profile6=view.findViewById(R.id.monther_layout_profile6);
        mother_layout_profile6.getLayoutTransition().enableTransitionType(LayoutTransition.CHANGING);
        mother_layout_profile7=view.findViewById(R.id.monther_layout_profile7);
        mother_layout_profile7.getLayoutTransition().enableTransitionType(LayoutTransition.CHANGING);
        mother_layout_profile8=view.findViewById(R.id.monther_layout_profile8);
        mother_layout_profile8.getLayoutTransition().enableTransitionType(LayoutTransition.CHANGING);
        mother_layout_profile9=view.findViewById(R.id.monther_layout_profile9);
        mother_layout_profile9.getLayoutTransition().enableTransitionType(LayoutTransition.CHANGING);

        layout_show_hide=view.findViewById(R.id.layout_show_hide);
        layout_show_hide2=view.findViewById(R.id.layout_show_hide2);
        layout_show_hide3=view.findViewById(R.id.layout_show_hide3);
        layout_show_hide4=view.findViewById(R.id.layout_show_hide4);
        layout_show_hide5=view.findViewById(R.id.layout_show_hide5);
        layout_show_hide6=view.findViewById(R.id.layout_show_hide6);
        layout_show_hide7=view.findViewById(R.id.layout_show_hide7);
        layout_show_hide8=view.findViewById(R.id.layout_show_hide8);
        layout_show_hide9=view.findViewById(R.id.layout_show_hide9);

        visibility_table_layout=view.findViewById(R.id.visibility_table_layout);
        visibility_table_layout2=view.findViewById(R.id.visibility_table_layout2);
        visibility_table_layout3=view.findViewById(R.id.visibility_table_layout3);
        visibility_table_layout4=view.findViewById(R.id.visibility_table_layout4);
        visibility_table_layout5=view.findViewById(R.id.visibility_table_layout5);
        visibility_table_layout6=view.findViewById(R.id.visibility_table_layout6);
        visibility_table_layout7=view.findViewById(R.id.visibility_table_layout7);
        visibility_table_layout8=view.findViewById(R.id.visibility_table_layout8);
        visibility_table_layout9=view.findViewById(R.id.visibility_table_layout9);
